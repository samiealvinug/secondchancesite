...
import { Play, Image as ImageIcon, Video, ArrowRight, Plus, Trash2, RefreshCw } from 'lucide-react';
import { useMediaGallery } from '../hooks/useMediaGallery';

export default function Media() {
  const { media, loading, addMedia, deleteMedia, refresh } = useMediaGallery();
  ...
  const handleAddPhoto = async () => {
    ...
    if (success) {
      ...
      alert('Failed to add photo. Check console for errors.');
    }
  };
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="flex justify-between items-start">
              <div>
                <span className="text-brand-red font-bold text-[11px] uppercase tracking-[0.3em] mb-6 block">Visual Journey</span>
                <h1 className="text-5xl md:text-8xl font-serif font-bold text-brand-ink mb-12 leading-none">
                  Media <span className="italic text-brand-red">Archive.</span>
                </h1>
              </div>
            </div>
      ...
      <section className="py-32 px-8 md:px-20 bg-white">
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col items-center text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-serif font-bold text-brand-ink mb-4">Our Story in Motion</h2>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
            <div className="max-w-xl">
              ...
              <h2 className="text-4xl md:text-5xl font-serif font-bold text-brand-ink">Impact in <span className="italic">Focus.</span></h2>
            </div>
