      ...
      <section className="py-20 px-8 md:px-20">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <h1 className="text-5xl md:text-8xl font-serif font-bold text-brand-ink mb-12 leading-none">
              Get in <span className="italic text-brand-red">Touch.</span>
            </h1>
            <p className="text-xl text-brand-ink/60 leading-relaxed font-light max-w-2xl">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-start">
            ...
            <div className="space-y-16">
              <div>
                <h2 className="text-4xl font-serif font-bold text-brand-ink mb-8">Reach Out to <span className="italic">Us.</span></h2>
              ...
              <div className="space-y-10">
                <div className="flex items-start gap-8 group">
                  <div className="bg-brand-cream w-16 h-16 rounded-none flex items-center justify-center text-brand-red shrink-0 group-hover:bg-brand-red group-hover:text-white transition-all shadow-sm">
                    <Mail className="w-7 h-7" />
                  </div>
                  <div>
                    <h4 className="text-[10px] uppercase tracking-widest font-bold text-brand-ink/40 mb-2">Email Us</h4>
                    <a href={`mailto:${settings.contactEmail}`} className="text-xl font-serif font-bold text-brand-ink hover:text-brand-red transition-colors">
                ...
                <div className="flex items-start gap-8 group">
                  ...
                  <div>
                    ...
                    <a href={`tel:${settings.contactPhone.replace(/\D/g, '')}`} className="text-xl font-serif font-bold text-brand-ink hover:text-brand-red transition-colors">
                ...
                <div className="flex items-start gap-8 group">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-serif font-bold text-brand-ink">United States, Uganda, India</p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-12 border-t border-brand-ink/5">
                ...
                <div className="flex gap-6">
                  {[
                    { icon: Instagram, href: "https://www.instagram.com/second_chance_at_life_" },
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              className="bg-brand-cream p-12 md:p-16 rounded-none border border-brand-ink/5 shadow-sm"
            >
